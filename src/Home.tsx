    ...
    <div className="row content">
      ...
      <div>
        ...
        <div className="description">
          Ever been stuck on the subway, not sure if you should transfer at the
          next station, but don't have service underground? Access all the
          realtime data of a transit system with Transit Data Access (packed
          into tiny Protobuf updates), as up to date as the last time you opened
          the web app and had a connection.
          <div className="mt-1">
            View on{' '}
            <a
